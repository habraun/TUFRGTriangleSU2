@everywhere function fill_main_patch!(
	...
	for qi in 1:N_m
		...
		@tensor begin
			bufferVP[L1,L4]=  	(
								+ VP_qi[L1,L2]*xpp_qi[L2,L3]*VP_qi[L3,L4]
								+ WP_qi[L1,L2]*xpp_qi[L2,L3]*WP_qi[L3,L4]
								)
			bufferVC[L1,L4]=  	(
								+ VC_qi[L1,L2]*xph_qi[L2,L3]*VC_qi[L3,L4]
								)
			bufferVD[L1,L4]=	(
								- VD_qi[L1,L2]*xph_qi[L2,L3]*VD_qi[L3,L4]*Nsymm*Msymm#4.0 is n*m 2 statt 4!!!
			...
			bufferWP[L1,L4]=  	(
								+ VP_qi[L1,L2]*xpp_qi[L2,L3]*WP_qi[L3,L4]
								+ WP_qi[L1,L2]*xpp_qi[L2,L3]*VP_qi[L3,L4]
								)
			bufferWC[L1,L4]=  	(
								+ VC_qi[L1,L2]*xph_qi[L2,L3]*WC_qi[L3,L4]
								+ WC_qi[L1,L2]*xph_qi[L2,L3]*VC_qi[L3,L4]
								+ WC_qi[L1,L2]*xph_qi[L2,L3]*WC_qi[L3,L4]*Msymm
								) #m
			bufferWD[L1,L4]=	(
								- WD_qi[L1,L2]*xph_qi[L2,L3]*WD_qi[L3,L4]*Nsymm #n
...
@everywhere function increment!(
	...
	println("Resolution:")
	println("Radial: ", string(3*(2^faktor))," Angular: ",string(phifaktor*120))
	...
	fill_main_patch!(incrementsv, incrementsw,bubbles,VP,VC,VD,WP,WC,WD,bufferVP,bufferVC,bufferVD,bufferWP,bufferWC,bufferWD,NM)
end
