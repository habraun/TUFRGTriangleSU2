...
@everywhere function start_flow(
    ...
    while (Iter<IterMax)&(Lambda>LambdaMin)
        ...
        increment!(incrementsv,incrementsw,bubbles,Lambda,t,t2,t3,mu,v,fv,w,fw,grid_bosons,grid_r,phifaktor,NM)
        ...
        println("vmax P: ",vmaxp," ",findmax(real.(v.P))[2])
        println("vmin P: ",vminp," ",findmax(real.(-v.P))[2])
        println("vmax C: ",vmaxc," ",findmax(real.(v.C))[2])
        println("vmin C: ",vminc," ",findmax(real.(-v.C))[2])
        println("vmax D: ",vmaxd," ",findmax(real.(v.D))[2])
        println("vmin D: ",vmind," ",findmax(real.(-v.D))[2])

        println("wmax P: ",wmaxp," ",findmax(real.(w.P))[2])
        println("wmin P: ",wminp," ",findmax(real.(-w.P))[2])
        println("wmax C: ",wmaxc," ",findmax(real.(w.C))[2])
        println("wmin C: ",wminc," ",findmax(real.(-w.C))[2])
        println("wmax D: ",wmaxd," ",findmax(real.(w.D))[2])
        println("wmin D: ",wmind," ",findmax(real.(-w.D))[2])
